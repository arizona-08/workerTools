...
const labels: Readonly<Record<string, string>> = {
  ...
  submodule: 'Sous-module', supportSystem: 'Système statique', criticalSectionLocation: 'Position critique', designShearForce: 'Effort tranchant de calcul', scope: 'Domaine de vérification', limitation: 'Limitation de méthode', criticalSectionPosition: 'Position de la section critique', longitudinalReinforcementPosition: 'Position des armatures longitudinales', longitudinalReinforcementArea: 'Aire des armatures longitudinales',
