...
const labels: Readonly<Record<string, string>> = {
  ...
  submodule: 'Sous-module', supportSystem: 'Système statique', criticalSectionLocation: 'Position critique', designShearForce: 'Effort tranchant de calcul', scope: 'Domaine de vérification', limitation: 'Limitation de méthode', criticalSectionPosition: 'Distance de la section critique', fixedEndDesignShearForce: 'Effort tranchant à l’encastrement', criticalSectionDesignShearForce: 'Effort tranchant à la section critique', criticalSectionFormula: 'Formule à la section critique', longitudinalReinforcementPosition: 'Position des armatures longitudinales', longitudinalReinforcementArea: 'Aire des armatures longitudinales',
  ...
  effectiveDepth: 'Hauteur utile', requiredArea: 'Armatures requises', minimumArea: 'Armatures minimales', targetArea: 'Armatures cibles', providedArea: 'Armatures fournies', serviceMoment: 'Moment ELS quasi-permanent utilisé', coverToLongitudinalBar: 'Enrobage jusqu’aux armatures longitudinales', transverseBarDiameter: 'Diamètre transversal utilisé pour la géométrie',
  longitudinalReinforcement: 'Ferraillage longitudinal', barCount: 'Nombre de barres', barDiameter: 'Diamètre des barres', source: 'Origine du ferraillage', position: 'Position des armatures principales', tensionFace: 'Face tendue', signedDesignMoment: 'Moment de calcul signé',
...
const units: Readonly<Record<string, string>> = {
  ...
  effectiveSpan: 'mm', width: 'mm', height: 'mm', nominalCover: 'mm', cNom: 'mm', cMin: 'mm', cMinDurability: 'mm', effectiveDepth: 'mm', criticalSectionPosition: 'mm', barDiameter: 'mm', transverseBarDiameter: 'mm', coverToLongitudinalBar: 'mm', serviceMoment: 'kN·m',
...
export class DetailValueList {
  ...
  private formatStatus(value: string): string {
    const translated = ({
      ...
      BEAM: 'Poutre', SLAB: 'Dalle', DESIGN: 'Dimensionnement', VERIFICATION: 'Vérification', REINFORCED_CONCRETE: 'Béton armé', RECTANGULAR: 'Rectangulaire', SIMPLY_SUPPORTED: 'Simplement appuyée', CANTILEVER: 'Console', BEAM_SIMPLE_RECTANGULAR: 'Poutre rectangulaire simplement appuyée', BEAM_CANTILEVER_RECTANGULAR: 'Poutre rectangulaire en console', FIXED_END: 'Encastrement', EFFECTIVE_DEPTH_FROM_FIXED_END: 'À une hauteur utile de l’encastrement', UNIFORMLY_DISTRIBUTED: 'Uniformément répartie', PERSISTENT_TRANSIENT: 'Persistante / transitoire', AUTO: 'Automatique', TOP: 'Partie supérieure', BOTTOM: 'Partie inférieure', NF_EN_1992_1_1_2005_FR: 'NF EN 1992-1-1:2005 — France',
      ...
      REINFORCEMENT_PROPOSAL_FOUND: 'Proposition de ferraillage disponible', SECONDARY_REINFORCEMENT_PROPOSAL_FOUND: 'Proposition d’armatures secondaires disponible', INSUFFICIENT_REINFORCEMENT_PER_LENGTH: 'Armatures insuffisantes par unité de longueur', MAXIMUM_SHEAR_RESISTANCE_EXCEEDED: 'Résistance maximale au cisaillement dépassée', SHEAR_RESISTANCE_INSUFFICIENT: 'Résistance au cisaillement insuffisante', MISSING_MAIN_REINFORCEMENT_PROPOSAL: 'Proposition d’armatures principales absente', REQUIRED_VERIFICATION_MISSING: 'Vérification requise absente', NO_EXPLICIT_DEFLECTION_CALCULATED: 'Aucune flèche explicite calculée', LONG_TERM_EFFECTS_NOT_EXPLICITLY_MODELLED: 'Effets de long terme non modélisés explicitement', PARTITION_DAMAGE_CHECK_NOT_MODELLED: 'Vérification des dommages aux cloisons non modélisée', UTILIZATION_UNAVAILABLE: 'Taux d’utilisation indisponible', CANTILEVER_FIXED_END_SCOPE: 'Méthode non prise en charge à l’encastrement', CANTILEVER_FIXED_END_CRITICAL_SECTION_NOT_MODELLED: 'Section critique de cisaillement à l’encastrement non modélisée', CANTILEVER_CRACK_VERIFICATION_REQUIRES_FIXED_END_STIRRUP_LAYOUT: 'Vérification de fissuration nécessitant un ferraillage transversal à l’encastrement', CANTILEVER_STRUCTURAL_FACTOR_NOT_DEFINED_IN_PROFILE: 'Facteur de système non défini pour la console', A: 'Catégorie A',
